...
const submit = () => {
  stationProductStore.update(page.props.stationProduct.station_product_id)
}

onMounted(() => {
  stationStore.ajaxList('A')
  productStore.ajaxList('A')
  Object.assign(stationProductStore.form, page.props.stationProduct)
})
</script>
...
<template>
  ...
  <AuthenticatedLayout>
    <div class="mb-3">
      <h5 class="text-h5 font-weight-bold">Actualizacion de producto por estacion</h5>
